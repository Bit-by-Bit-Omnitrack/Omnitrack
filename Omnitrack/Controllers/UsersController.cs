...
namespace Omnitrack.Controllers
{
    public class UsersController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,EmployeeNumber,FirstName,MiddleName,LastName,PhoneNumber,EmailAddress,Country,DateOfBirth,Address,Role,CreatedByID,CreatedOn,ModifiedByID,ModifiedOn")] User user)
        {
            if (id != user.Id)
            {
                return NotFound();
